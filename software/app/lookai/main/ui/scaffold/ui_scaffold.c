...
static lv_obj_t *create_body(lv_obj_t *screen, bool show_bottom_slice)
{
    ...
    lv_obj_set_size(body, UI_THEME_BODY_WIDTH, body_height);
...
lv_obj_t *ui_scaffold_create(lv_obj_t *screen, const ui_scaffold_config_t *config)
{
    ...
    return create_body(screen, show_bottom_slice);
}
